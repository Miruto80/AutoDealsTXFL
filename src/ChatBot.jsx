...
{keywords: ["what do you offer","how you guys work","who you are","how we are","explain me how it works","works"],answer: "We’re Auto Brokers — not a traditional dealership. Our job is to help you find the right vehicle based on your budget, needs, and preferences. We work as a third party, connecting you with trusted dealerships in Texas and Florida that can best assist your specific situation. Our focus is simple: we work for you, not the dealership — to make the process easier, faster, and more personalized. For more info, feel free to use 'Contact' to have one of the representatives reach out to you shortly."},  
      ...
      {open ? (
        <>
          ...
          <form onSubmit={handleSend} style={{ display: "flex", width: "100%", borderTop: "1px solid #eee" }}>
            ...
            />
            <button type="submit" style={{ background: "#007bff", color: "#fff", border: "none", padding: "0 16px", cursor: "pointer" }}>Enviar</button>
          </form>
        </>
      ) : (
